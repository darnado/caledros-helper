 ...
 *
 * When the 'caledros_helper_deactivate_rest_api' option is equal to 1, then
 * unauthenticated requests are rejected with a 401 WP_Error. When the requests
 * are already authenticated, or rejected, by prior callbacks, then the
 * authentication result is passed through unchanged.
 *
 * Hooked into the 'rest_authentication_errors' filter.
 *
 * @param null|true|WP_Error $result    Authentication result from prior callbacks.
 * @return null|true|WP_Error           401 WP_Error or unchanged authentication result
